...
import {fetchAllProductAsync,fetchProductsByFiltersAsync ,selectAllProducts} from '../productListSlice';
...
const sortOptions = [
  { name: 'Best Rating',        sorting : 'rating', order:"desc"   ,   current: false },
  { name: 'Price: Low to High', sorting : 'price',  order:"asc "   ,  current: false },
  { name: 'Price: High to Low', sorting : 'price',  order:"desc "  ,   current: false },
]
...
export default function ProductList() {
  ...
  useEffect(()=>{dispatch(fetchAllProductAsync({filter}))},[dispatch,filter,sort]);
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              <DesktopFilterFilter handleFilter={handleFilter}></DesktopFilterFilter>
...
function DesktopFilterFilter({handleFilter}){
  return( 
